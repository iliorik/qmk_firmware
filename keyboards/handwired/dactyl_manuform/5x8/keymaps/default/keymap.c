...
bool oled_task_user(void) {
    // Определяем, какая половина клавиатуры
    if (is_keyboard_master()) {
        ...
        // Вторая половина - можно показать логотип или другую информацию
...
enum layers { _QWERTY, _RIGHT2LEFT, _LEFTIRIGHT, _LEFTNUMPAD };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   /* Base (right to left on hold button)
    ...
    [_RIGHT2LEFT] = LAYOUT_5x8(
        ...
        DM_PLY1,  KC_QUOT,       KC_SCLN,       KC_L,    KC_K,   KC_J,   KC_H,   KC_PSCR,      KC_NO,    KC_NO,    KC_LEFT,  KC_DOWN,  KC_UP,   KC_RIGHT,  KC_NO,   KC_ENT,
